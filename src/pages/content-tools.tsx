...
const devices = [
  { id: "DYN-001", name: "Dyniq Prototype #001", site: "Pilot Facility A", status: "Online", battery: "86%", cycles: 54, lastPhoto: "AI image scan ready" },
  { id: "DYN-002", name: "Dyniq Prototype #002", site: "Pilot Facility B", status: "Online", battery: "72%", cycles: 41, lastPhoto: "Needs left-edge review" },
  { id: "DYN-LAB", name: "Dyniq Lab Unit", site: "Internal testing", status: "Standby", battery: "100%", cycles: 33, lastPhoto: "No active scan" },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {devices.map((device) => (
          <Card key={device.id} className="border-white/10 bg-card/80">
            <CardHeader>
