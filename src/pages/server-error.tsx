      ...
      <Card className="max-w-2xl w-full border-primary/20 shadow-2xl shadow-primary/10">
        <CardContent className="pt-6">
          ...
          >
            ...
            />
            <img src={serverError} alt="Server Error" width={200} className="relative z-10" />
          </motion.div>
          ...
          >
            ...
            >
              Oops! Something went wrong on our end. Our servers are having trouble processing your request. Please try again later.
            </motion.p>
